    ...
    <>
      <ul className="navbar-nav sidebar accordion" id="accordionSidebar">
        ...
        <li className="nav-item mx-1 my-1">
          <NavLink to="/" className={({ isActive }) => `nav-link custom-link ${isActive ? "active-links" : ""}`}>
            ...
            </svg> <span>Libros</span>
          </NavLink>
        </li>
        <li className="nav-item mx-1 my-1">
          <NavLink to="/favorite-books" className={({ isActive }) => `nav-link custom-link ${isActive ? "active-links" : ""}`}>
        ...
        <li className="nav-item mx-1 my-1">
          <NavLink to="/my-categories" className={({ isActive }) => `nav-link custom-link ${isActive ? "active-links" : ""}`}>
        ...
        <li className="nav-item mx-1 my-1">
          <NavLink to="/messages" className={({ isActive }) => `nav-link custom-link ${isActive ? "active-links" : ""}`}>
        ...
        {(user?.rol === "ADMIN" || user?.rol === "BIBLIOTECARIO") && (
          <li className="nav-item mx-1 my-1">
            <NavLink 
              to="/dashboard" 
              className={({ isActive }) => `nav-link custom-link ${isActive ? "active-links" : ""}`}>
        ...
        <h3 className="sidebar-subtitle">Categorias</h3>
          {categories.map((category) => (
            <li key={category.id} className="nav-item mx-1 my-1">
              <NavLink
                to={`/books/category/${category.nombre.toLowerCase().replace(/\s+/g, "-")}`}
